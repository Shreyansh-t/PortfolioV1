      ...
      switch (currentPath) {
        case 'experience':
          return [
            ...
            '   • Researching an AB-Tree index in DuckDB C++ for high-performance random indexing & sampling',
            '   • Mapped DuckDB execution pipeline via GDB, tracing ART lifecycle for secondary index hook-ins',
            '   • Analyzed chunk-level bulk-loading process for AB-Trees and metadata preservation during compilation',
            '   • Developing async merging pipeline for chunk-level indices to optimize OLAP query execution paths',
            '',
    ...
    cat: (args: string[]) => {
      ...
      const fileContents: { [key: string]: string[] } = {
        ...
        'work-history.txt': [
          ...
          '   • Researching an AB-Tree index in DuckDB C++ for random indexing & sampling',
          '   • Mapped DuckDB execution pipeline via GDB, tracing ART lifecycle for secondary index hook-ins',
          '   • Analyzed chunk-level bulk-loading process for AB-Trees and metadata preservation',
          '   • Developing async merging pipeline for chunk-level indices to optimize OLAP query execution',
          '',
